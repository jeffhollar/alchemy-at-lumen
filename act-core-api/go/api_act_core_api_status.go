...
func GetServiceInfo(w http.ResponseWriter, r *http.Request) {
	...
	serviceInformation.App.Name = "act-core-api-service"
	serviceInformation.App.Version = "1.0.0=000"
	serviceInformation.App.Description = "A Go-based service that provides an ACT core interface for ACT Core API services and Temporal.io workflows."
	serviceInformation.App.Attributes.DisplayName = "Act Core API Service"
	...
	serviceInformation.Build.Artifact = "act-core-api-service"
	serviceInformation.Build.Name = "Act Core API Service"
